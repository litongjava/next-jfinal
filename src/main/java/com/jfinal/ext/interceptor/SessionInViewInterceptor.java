...
public class SessionInViewInterceptor implements Interceptor {
  ...
  public static class JFinalSession extends HashMap implements HttpSession {
    ...
    public com.jfinal.servlet.http.HttpSessionContext getSessionContext() {
 ...
 * 
 * Controller c = inv.getController(); HttpSession hs = c.getSession(createSession); if (hs != null) { c.setAttr("session", new JFinalSession(hs)); } }
 */
